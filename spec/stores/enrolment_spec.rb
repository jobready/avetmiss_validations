...
describe AvetmissData::Stores::Enrolment do
  context 'imports the NAT00120 file' do

    context 'NAT File' do
      specify { expect(AvetmissData::Stores::Enrolment.file_name).not_to be_blank }
      specify { expect(AvetmissData::Stores::Enrolment.file_name).to eq('NAT00120') }
    end
