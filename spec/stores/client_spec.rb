...
describe AvetmissData::Stores::Client do
  context 'imports the NAT00080 file' do

    context 'NAT File' do
      specify { expect(AvetmissData::Stores::Client.file_name).not_to be_blank }
      specify { expect(AvetmissData::Stores::Client.file_name).to eq('NAT00080') }
    end
